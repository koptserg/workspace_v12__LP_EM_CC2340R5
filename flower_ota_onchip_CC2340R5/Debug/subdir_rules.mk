...
build-807797023: ../on_off_switch_ota_client_onchip.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/sysconfig_1.22.0/sysconfig_cli.bat" --script "C:/Users/Sergey/workspace_v12/flower_ota_onchip_CC2340R5/on_off_switch_ota_client_onchip.syscfg" -o "syscfg" -s "C:/ti/simplelink_lowpower_f3_sdk_8_40_02_01/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

syscfg/ti_devices_config.c: build-807797023 ../on_off_switch_ota_client_onchip.syscfg
syscfg/ti_radio_config.c: build-807797023
syscfg/ti_radio_config.h: build-807797023
syscfg/ti_drivers_config.c: build-807797023
syscfg/ti_drivers_config.h: build-807797023
syscfg/ti_utils_runtime_rov.js.xs: build-807797023
syscfg/ti_log_config.c: build-807797023
syscfg/ti_log_config.h: build-807797023
syscfg/ti_utils_build_linker.cmd.genlibs: build-807797023
syscfg/ti_utils_build_linker.cmd.genmap: build-807797023
syscfg/ti_utils_build_compiler.opt: build-807797023
syscfg/syscfg_c.rov.xs: build-807797023
syscfg/ti_zigbee_config.h: build-807797023
syscfg/ti_zigbee_config.c: build-807797023
syscfg/FreeRTOSConfig.h: build-807797023
syscfg/ti_freertos_config.c: build-807797023
syscfg/ti_freertos_portable_config.c: build-807797023
syscfg: build-807797023
